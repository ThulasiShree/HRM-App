      ...
      <div className="row">
        ...
        <div className="col-md-10">
          ...
          <div className='d-flex flex-row justify-content-between mt-4 ms-3'>
            <span className='fs-4 fw-medium'>Attendances</span>
          ...
          <div className="mx-4 my-4">
            <div className="d-flex flex-row align-items-center justify-content-between">
              <div className="d-flex gap-3">
                <span className='fs-5 fw-medium'>Attendances</span>
                <span className='fs-5 fw-medium text-secondary'>250</span>
              </div>
              <Form>
                <InputGroup>
                  <Form.Control type="text" placeholder="Type here…" aria-label="Search" className='search-text border-0' />
